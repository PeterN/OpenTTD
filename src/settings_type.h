...
struct GUISettings {
	...
	uint8_t  default_signal_type;              ///< the signal type to build by default.
	uint8_t  cycle_signal_types;               ///< what signal types to cycle with the build signal tool.
...
struct NetworkSettings {
	...
	uint8_t       max_spectators;                           ///< maximum amount of spectators
