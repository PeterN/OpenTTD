...
struct IntSettingDesc : SettingDesc {
	...
	IntSettingDesc(SaveLoad save, const char *name, SettingFlag flags, bool startup, int32_t def,
...
struct OneOfManySettingDesc : IntSettingDesc {
	...
	OneOfManySettingDesc(SaveLoad save, const char *name, SettingFlag flags, bool startup, int32_t def,
