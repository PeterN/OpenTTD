...
struct TimetableWindow : Window {
	...
	{
		switch (widget) {
			case WID_VT_CAPTION: param.SetParam(0, this->vehicle->index); break;
			case WID_VT_EXPECTED: param.SetParam(0, this->show_expected ? STR_TIMETABLE_EXPECTED : STR_TIMETABLE_SCHEDULED); break;
		}
	}
