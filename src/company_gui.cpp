...
class SelectCompanyManagerFaceWindow : public Window
{
	 ...
	 */
	void DrawFaceStringLabel(byte widget_index, uint8_t val, bool is_bool_widget) const
	{
		StringID str;
	...
	void OnQueryTextFinished(char *str) override
	{
		...
		switch (this->query_widget) {
			...
			case WID_C_GIVE_MONEY: {
				...
				uint32_t money_c = Clamp(ClampToI32(money), 0, 20000000); // Clamp between 20 million and 0
