 ...
 */
static bool VerifyElementContentParameters(StoryPageID page_id, StoryPageElementType type, TileIndex tile, uint32_t reference, const char *text)
{
 ...
 * @param text The text parameter of the DoCommand proc
 */
static void UpdateElement(StoryPageElement &pe, TileIndex tile, uint32_t reference, const char *text)
{
	switch (pe.type) {
		case SPET_TEXT:
 ...
 */
CommandCost CmdCreateStoryPage(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
 ...
 * @return the cost of this operation or an error
 */
CommandCost CmdCreateStoryPageElement(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
 ...
 * @return the cost of this operation or an error
 */
CommandCost CmdUpdateStoryPageElement(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
 ...
 * @return the cost of this operation or an error
 */
CommandCost CmdSetStoryPageTitle(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
	if (_current_company != OWNER_DEITY) return CMD_ERROR;
	StoryPageID page_id = (StoryPageID)GB(p1, 0, 16);
	if (!StoryPage::IsValidID(page_id)) return CMD_ERROR;
 ...
 * @return the cost of this operation or an error
 */
CommandCost CmdSetStoryPageDate(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
	if (_current_company != OWNER_DEITY) return CMD_ERROR;
	StoryPageID page_id = (StoryPageID)GB(p1, 0, 16);
	if (!StoryPage::IsValidID(page_id)) return CMD_ERROR;
 ...
 * @return the cost of this operation or an error
 */
CommandCost CmdShowStoryPage(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
	if (_current_company != OWNER_DEITY) return CMD_ERROR;
	StoryPageID page_id = (StoryPageID)GB(p1, 0, 16);
	if (!StoryPage::IsValidID(page_id)) return CMD_ERROR;
 ...
 * @return the cost of this operation or an error
 */
CommandCost CmdRemoveStoryPage(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
	if (_current_company != OWNER_DEITY) return CMD_ERROR;
 ...
 * @return the cost of this operation or an error
 */
CommandCost CmdRemoveStoryPageElement(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
	if (_current_company != OWNER_DEITY) return CMD_ERROR;
 ...
 */
CommandCost CmdStoryPageButton(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
	StoryPageElementID page_element_id = (StoryPageElementID)GB(p1, 0, 16);
