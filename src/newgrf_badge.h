...
public:
	...
	GrfSpecFeatureMask features = 0; ///< Bitmask of which features use this badge.
	...
	inline void SetFeature(GrfSpecFeature feature)
	{
		SetBit(this->features, feature);
	}

	inline bool HasFeature(GrfSpecFeature feature) const
	{
		return HasBit(this->features, feature);
	}
};
