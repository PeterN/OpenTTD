	...
	{ // Main Sprites
		{
			...
			SPR_RAIL_TRACK_Y + 6,
			SPR_RAIL_TRACK_N_S,
			SPR_RAIL_TRACK_N_S + 1,
			SPR_RAIL_TRACK_BASE,
			SPR_RAIL_TRACK_BASE + 1,
			SPR_RAIL_TRACK_BASE + 2,
			SPR_RAIL_TRACK_BASE + 3,
			SPR_RAIL_TRACK_BASE + 4,
			SPR_RAIL_SINGLE_X, SPR_RAIL_SINGLE_Y,
	...
	{ // Main Sprites
		{
			...
			SPR_MONO_TRACK_Y + 6,
			SPR_MONO_TRACK_N_S,
			SPR_MONO_TRACK_N_S + 1,
			SPR_MONO_TRACK_BASE,
			SPR_MONO_TRACK_BASE + 1,
			SPR_MONO_TRACK_BASE + 2,
			SPR_MONO_TRACK_BASE + 3,
			SPR_MONO_TRACK_BASE + 4,
			SPR_MONO_SINGLE_X, SPR_MONO_SINGLE_Y,
	...
	{ // Main sprites
		{
			...
			SPR_MGLV_TRACK_Y + 6,
			SPR_MGLV_TRACK_N_S,
			SPR_MGLV_TRACK_N_S + 1,
			SPR_MGLV_TRACK_BASE,
			SPR_MGLV_TRACK_BASE + 1,
			SPR_MGLV_TRACK_BASE + 2,
			SPR_MGLV_TRACK_BASE + 3,
			SPR_MGLV_TRACK_BASE + 4,
			SPR_MGLV_SINGLE_X, SPR_MGLV_SINGLE_Y,
