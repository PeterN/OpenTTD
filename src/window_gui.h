...
public:
	...
	EventState HandleEditBoxKey(int wid, WChar key, uint16_t keycode);
	 ...
	 */
	virtual EventState OnKeyPress(WChar key, uint16_t keycode) { return ES_NOT_HANDLED; }
...
void GuiShowTooltips(Window *parent, StringID str, uint paramcount = 0, const uint64_t params[] = nullptr, TooltipCloseCondition close_tooltip = TCC_HOVER);
