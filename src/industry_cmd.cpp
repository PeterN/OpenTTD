 ...
 */
static CommandCost CheckIfIndustryTilesAreFree(TileIndex tile, const IndustryTileLayout &layout, size_t layout_index, int type, uint16_t initial_random_bits, Owner founder, IndustryAvailabilityCallType creation_type, bool *custom_shape_check = nullptr)
{
 ...
 */
CommandCost CmdBuildIndustry(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
 ...
 */
CommandCost CmdIndustryCtrl(TileIndex tile, DoCommandFlag flags, uint32_t p1, uint32_t p2, const std::string &text)
{
