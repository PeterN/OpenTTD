 ...
 */
static inline void MakeWater(TileIndex t, Owner o, WaterClass wc, uint8_t random_bits)
{
	SetTileType(t, MP_WATER);
	SetTileOwner(t, o);
	SetWaterClass(t, wc);
 ...
 */
static inline void MakeRiver(TileIndex t, uint8_t random_bits)
{
 ...
 * @param random_bits Random bits to be set for this tile
 */
static inline void MakeCanal(TileIndex t, Owner o, uint8_t random_bits)
{
