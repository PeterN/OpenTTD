...
static const SaveLoad _group_desc[] = {
	...
	SLE_CONDNULL(2,                                                         SL_MIN_VERSION,  SLV_164), // num_vehicle
	 ...
	 SLE_CONDVAR(Group, livery.flags,       SLE_UINT8,                     SLV_GROUP_LIVERIES, SL_MAX_VERSION),
	 ...
	 SLE_CONDVAR(Group, livery.rgb1,        SLE_UINT32,                    SLV_RGB_LIVERIES, SL_MAX_VERSION),
	 SLE_CONDVAR(Group, livery.rgb2,        SLE_UINT32,                    SLV_RGB_LIVERIES, SL_MAX_VERSION),
