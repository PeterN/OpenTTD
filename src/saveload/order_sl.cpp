...
SaveLoadTable GetOrderDescription()
{
	static const SaveLoad _order_desc[] = {
		 ...
		 SLE_CONDVAR(Order, refit_cargo,    SLE_FILE_U8 | SLE_VAR_U16, SLV_36, SLV_EXTEND_CARGOTYPES_MORE),
		 SLE_CONDVAR(Order, refit_cargo,    SLE_UINT16,  SLV_EXTEND_CARGOTYPES_MORE, SL_MAX_VERSION),
