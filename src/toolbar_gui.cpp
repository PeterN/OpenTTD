...
static const int GRMN_EXPENSES_GRAPH = -7; ///< Show company expenses graph
...
static CallBackFunction ToolbarGraphsClick(Window *w)
{
	...
	list.push_back(MakeDropDownListStringItem(STR_GRAPH_MENU_EXPENSES_GRAPH, GRMN_EXPENSES_GRAPH));
...
static CallBackFunction MenuClickGraphsOrLeague(int index)
{
	switch (index) {
		...
		case GRMN_EXPENSES_GRAPH: ShowCompanyExpensesGraph(); break;
