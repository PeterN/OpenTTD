...
void GfxFillRect(int left, int top, int right, int bottom, int colour, FillRectMode mode = FILLRECT_OPAQUE, Colour rgb = 0);
void GfxDrawLine(int left, int top, int right, int bottom, int colour, int width = 1, int dash = 0, Colour rgb = 0);
