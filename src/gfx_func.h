...
Dimension GetScaledSpriteSize(SpriteID sprid, Point *offset = nullptr); /* widget.cpp */
Dimension GetScaledSpriteSizeWithOffset(SpriteID sprid, Point *offset = nullptr);
void DrawSpriteViewport(SpriteID img, PaletteID pal, int x, int y, const SubSprite *sub = nullptr);
void DrawSprite(SpriteID img, PaletteID pal, int x, int y, const SubSprite *sub = nullptr, std::optional<ZoomLevel> zoom = {});
