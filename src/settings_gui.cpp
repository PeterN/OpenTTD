		...
		NWidget(NWID_SELECTION, INVALID_COLOUR, WID_GO_TAB_SELECTION),
			...
			NWidget(NWID_VERTICAL), SetPadding(WidgetDimensions::unscaled.sparse), SetPIP(0, WidgetDimensions::unscaled.vsep_wide, 0),
				...
				NWidget(WWT_FRAME, COLOUR_GREY), SetDataTip(STR_GAME_OPTIONS_FONT_NORMAL, STR_NULL), SetPIP(0, WidgetDimensions::unscaled.vsep_normal, 0),
					NWidget(WWT_PUSHTXTBTN, COLOUR_GREY, WID_GO_FONT_NORMAL_BUTTON), SetFill(1, 0), SetDataTip(STR_GAME_OPTIONS_FONT_SETTING, STR_GAME_OPTIONS_FONT_SETTING_TOOLTIP),
				EndContainer(),
				NWidget(WWT_FRAME, COLOUR_GREY), SetDataTip(STR_GAME_OPTIONS_FONT_SMALL, STR_NULL), SetPIP(0, WidgetDimensions::unscaled.vsep_normal, 0),
					NWidget(WWT_PUSHTXTBTN, COLOUR_GREY, WID_GO_FONT_SMALL_BUTTON), SetFill(1, 0), SetDataTip(STR_GAME_OPTIONS_FONT_SETTING, STR_GAME_OPTIONS_FONT_SETTING_TOOLTIP),
				EndContainer(),
				NWidget(WWT_FRAME, COLOUR_GREY), SetDataTip(STR_GAME_OPTIONS_FONT_LARGE, STR_NULL), SetPIP(0, WidgetDimensions::unscaled.vsep_normal, 0),
					NWidget(WWT_PUSHTXTBTN, COLOUR_GREY, WID_GO_FONT_LARGE_BUTTON), SetFill(1, 0), SetDataTip(STR_GAME_OPTIONS_FONT_SETTING, STR_GAME_OPTIONS_FONT_SETTING_TOOLTIP),
				EndContainer(),
				NWidget(WWT_FRAME, COLOUR_GREY), SetDataTip(STR_GAME_OPTIONS_FONT_MONO, STR_NULL), SetPIP(0, WidgetDimensions::unscaled.vsep_normal, 0),
					NWidget(WWT_PUSHTXTBTN, COLOUR_GREY, WID_GO_FONT_MONO_BUTTON),  SetFill(1, 0), SetDataTip(STR_GAME_OPTIONS_FONT_SETTING, STR_GAME_OPTIONS_FONT_SETTING_TOOLTIP),
				EndContainer(),
#endif /* HAS_TRUETYPE_FONT */
			EndContainer(),
