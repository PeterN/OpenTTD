...
std::unique_ptr<DropDownListItem> MakeDropDownListIconItem(SpriteID sprite, PaletteID palette, std::string &&str, int value, bool masked = false, bool shaded = false);
