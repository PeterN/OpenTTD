...
public:
	...
	uint8_t padding_top;    ///< Paddings added to the top of the widget. Managed by parent container widget.
	uint8_t padding_right;  ///< Paddings added to the right of the widget. Managed by parent container widget. (parent container may swap this with padding_left for RTL)
	uint8_t padding_bottom; ///< Paddings added to the bottom of the widget. Managed by parent container widget.
	uint8_t padding_left;   ///< Paddings added to the left of the widget. Managed by parent container widget. (parent container may swap this with padding_right for RTL)

	uint8_t uz_padding_top;    ///< Unscaled top padding, for resize calculation.
	uint8_t uz_padding_right;  ///< Unscaled right padding, for resize calculation.
	uint8_t uz_padding_bottom; ///< Unscaled bottom padding, for resize calculation.
	uint8_t uz_padding_left;   ///< Unscaled left padding, for resize calculation.
...
struct NWidgetPartPaddings {
	uint8_t top, right, bottom, left; ///< Paddings for all directions.
};
