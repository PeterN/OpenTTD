...
protected:
	...
	uint8 uz_pip_pre;            ///< Amount of space before first widget.
	uint8 uz_pip_inter;          ///< Amount of space between widgets.
	uint8 uz_pip_post;           ///< Amount of space after last widget.
};
