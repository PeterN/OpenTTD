 ...
 * "overloaded".
 */
const uint8 LinkGraphOverlay::LINK_COLOURS[][7] = {
	{ 0x0f, 0xd1, 0x57, 0x53, 0xbd, 0xb9, 0xb5 }, // Green to red
	{ 0x0f, 0xd1, 0x57, 0x53, 0x95, 0x93, 0x91 }, // Green to blue
	{ 0x0f, 0x0b, 0x07, 0x03, 0xbd, 0xb9, 0xb5 }, // Grey to red
	{ 0x0f, 0x0b, 0x09, 0x07, 0x05, 0x03, 0x01 }, // Greyscale
};
...
{
	size_t num_cargo = _sorted_cargo_specs.size();
...
static const NWidgetPart _nested_linkgraph_legend_widgets[] = {
	...
	NWidget(WWT_PANEL, COLOUR_DARK_GREEN),
		NWidget(NWID_HORIZONTAL), SetPadding(2), SetPIP(0, WidgetDimensions::unscaled.hsep_wide, 0),
