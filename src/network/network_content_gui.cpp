...
void BaseNetworkContentDownloadStatusWindow::UpdateWidgetSize(WidgetIndex widget, Dimension *size, const Dimension &padding, Dimension *fill, Dimension *resize)
{
	switch (widget) {
...
void BaseNetworkContentDownloadStatusWindow::DrawWidget(const Rect &r, WidgetIndex widget) const
{
	switch (widget) {
		case WID_NCDS_PROGRESS_BAR: {
