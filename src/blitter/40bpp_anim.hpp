...
public:
	...
	void CopyFromBuffer(void *video, const void *src, int width, int height, int src_pitch) override;
	void CopyToBuffer(const void *video, void *dst, int width, int height, int dst_pitch) override;
