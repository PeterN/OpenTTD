...
public:
	...
	void SetPixel(void *video, int x, int y, uint8 colour, Colour rgb) override;
	void DrawLine(void *video, int x, int y, int x2, int y2, int screen_width, int screen_height, uint8 colour, Colour rgb, int width, int dash) override;
	void DrawRect(void *video, int width, int height, uint8 colour, Colour rgb) override;
