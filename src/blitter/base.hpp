...
public:
	 ...
	 */
	virtual void SetPixel(void *video, int x, int y, uint32 colour) = 0;
	 ...
	 * @param colour A 8bpp mapping colour with optional packed RGB colour.
	 */
	virtual void DrawRect(void *video, int width, int height, uint32 colour) = 0;
	 ...
	 */
	virtual void DrawLine(void *video, int x, int y, int x2, int y2, int screen_width, int screen_height, uint32 colour, int width, int dash = 0) = 0;
