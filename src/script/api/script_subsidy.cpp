...
/* static */ bool ScriptSubsidy::Create(CargoID cargo_type, SubsidyParticipantType from_type, uint16_t from_id, SubsidyParticipantType to_type, uint16_t to_id)
{
...
/* static */ int32_t ScriptSubsidy::GetSourceIndex(SubsidyID subsidy_id)
{
...
/* static */ int32_t ScriptSubsidy::GetDestinationIndex(SubsidyID subsidy_id)
{
	if (!IsValidSubsidy(subsidy_id)) return INVALID_STATION;
