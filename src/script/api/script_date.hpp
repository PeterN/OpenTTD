...
public:
	 ...
	 * @return The year.
	 */
	static int32_t GetYear(Date date);
	 ...
	 * @return The month.
	 */
	static int32_t GetMonth(Date date);
	 ...
	 * @return The day.
	 */
	static int32_t GetDayOfMonth(Date date);
	 ...
	 * @return The date.
	 */
	static Date GetDate(int32_t year, int32_t month, int32_t day_of_month);
