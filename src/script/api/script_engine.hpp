...
public:
	 ...
	 */
	static int32_t GetCapacity(EngineID engine_id);
	 ...
	 */
	static int32_t GetReliability(EngineID engine_id);
	 ...
	 */
	static int32_t GetMaxSpeed(EngineID engine_id);
	 ...
	 */
	static int32_t GetMaxAge(EngineID engine_id);
	 ...
	 */
	static int32_t GetPower(EngineID engine_id);
	 ...
	 */
	static int32_t GetWeight(EngineID engine_id);
	 ...
	 */
	static int32_t GetMaxTractiveEffort(EngineID engine_id);
