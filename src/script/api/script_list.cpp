...
protected:
	...
	int64_t item_next;        ///< The next item we will show.
...
public:
	...
	int64_t Begin()
	{
		...
		int64_t item_current = this->item_next;
		FindNext();
		return item_current;
	}
...
bool ScriptList::HasItem(int64_t item)
{
...
void ScriptList::AddItem(int64_t item, int64_t value)
{
	this->modifications++;
...
void ScriptList::RemoveItem(int64_t item)
{
	this->modifications++;
	...
	int64_t value = item_iter->second;
...
int64_t ScriptList::Begin()
{
	this->initialized = true;
	return this->sorter->Begin();
}

int64_t ScriptList::Next()
{
	if (!this->initialized) {
...
int32_t ScriptList::Count()
{
	return (int32_t)this->items.size();
}

int64_t ScriptList::GetValue(int64_t item)
{
	ScriptListMap::const_iterator item_iter = this->items.find(item);
	return item_iter == this->items.end() ? 0 : item_iter->second;
}

bool ScriptList::SetValue(int64_t item, int64_t value)
{
	this->modifications++;
	...
	int64_t value_old = item_iter->second;
...
void ScriptList::RemoveAboveValue(int64_t value)
{
	this->modifications++;
...
void ScriptList::RemoveBelowValue(int64_t value)
{
	this->modifications++;
...
void ScriptList::RemoveBetweenValue(int64_t start, int64_t end)
{
	this->modifications++;
...
void ScriptList::RemoveValue(int64_t value)
{
	this->modifications++;
...
void ScriptList::RemoveTop(int32_t count)
{
	this->modifications++;
...
void ScriptList::RemoveBottom(int32_t count)
{
	this->modifications++;
...
void ScriptList::KeepAboveValue(int64_t value)
{
	this->modifications++;
...
void ScriptList::KeepBelowValue(int64_t value)
{
	this->modifications++;
...
void ScriptList::KeepBetweenValue(int64_t start, int64_t end)
{
	this->modifications++;
...
void ScriptList::KeepValue(int64_t value)
{
	this->modifications++;
...
void ScriptList::KeepTop(int32_t count)
{
	this->modifications++;
...
void ScriptList::KeepBottom(int32_t count)
{
	this->modifications++;
