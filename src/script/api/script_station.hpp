...
public:
	 ...
	 */
	static int32_t GetCargoWaiting(StationID station_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetCargoWaitingFrom(StationID station_id, StationID from_station_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetCargoWaitingVia(StationID station_id, StationID via_station_id, CargoID cargo_id);
	 ...
	 * @note if ScriptCargo.GetCargoDistributionType(cargo_id) == ScriptCargo.DT_MANUAL, then all waiting cargo will have STATION_INVALID as next hop.
	 */
	static int32_t GetCargoWaitingFromVia(StationID station_id, StationID from_station_id, StationID via_station_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetCargoPlanned(StationID station_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetCargoPlannedFrom(StationID station_id, StationID from_station_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetCargoPlannedVia(StationID station_id, StationID via_station_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetCargoPlannedFromVia(StationID station_id, StationID from_station_id, StationID via_station_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetCargoRating(StationID station_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetCoverageRadius(ScriptStation::StationType station_type);
	 ...
	 * @return The radius in tiles.
	 */
	static int32_t GetStationCoverageRadius(StationID station_id);
	 ...
	 */
	static int32_t GetDistanceManhattanToTile(StationID station_id, TileIndex tile);
	 ...
	 * @return The distance between station and tile.
	 */
	static int32_t GetDistanceSquareToTile(StationID station_id, TileIndex tile);
...
private:
	...
	template<bool Tfrom, bool Tvia>
	static int32_t CountCargoWaiting(StationID station_id, StationID from_station_id,
			StationID via_station_id, CargoID cargo_id);

	template<bool Tfrom, bool Tvia>
	static int32_t CountCargoPlanned(StationID station_id, StationID from_station_id,
			StationID via_station_id, CargoID cargo_id);
