...
public:
	 ...
	 */
	static int32_t GetIndustryCount();
	 ...
	 */
	static int32_t GetStockpiledCargo(IndustryID industry_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetLastMonthProduction(IndustryID industry_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetLastMonthTransported(IndustryID industry_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetLastMonthTransportedPercentage(IndustryID industry_id, CargoID cargo_id);
	 ...
	 */
	static int32_t GetAmountOfStationsAround(IndustryID industry_id);
	 ...
	 */
	static int32_t GetDistanceManhattanToTile(IndustryID industry_id, TileIndex tile);
	 ...
	 * @return The distance between industry and tile.
	 */
	static int32_t GetDistanceSquareToTile(IndustryID industry_id, TileIndex tile);
	 ...
	 * @api -ai
	 */
	static int32_t GetLastProductionYear(IndustryID industry_id);
	 ...
	 * @api -ai
	 */
	static uint32_t GetControlFlags(IndustryID industry_id);
	 ...
	 * @api -ai
	 */
	static bool SetControlFlags(IndustryID industry_id, uint32_t control_flags);
