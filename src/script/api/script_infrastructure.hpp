...
public:
	 ...
	 */
	static uint32_t GetRailPieceCount(ScriptCompany::CompanyID company, ScriptRail::RailType railtype);
	 ...
	 */
	static uint32_t GetRoadPieceCount(ScriptCompany::CompanyID company, ScriptRoad::RoadType roadtype);
	 ...
	 */
	static uint32_t GetInfrastructurePieceCount(ScriptCompany::CompanyID company, Infrastructure infra_type);
