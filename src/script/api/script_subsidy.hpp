...
public:
	 ...
	 * @api -ai
	 */
	static bool Create(CargoID cargo_type, SubsidyParticipantType from_type, uint16_t from_id, SubsidyParticipantType to_type, uint16_t to_id);
	 ...
	 */
	static int32_t GetSourceIndex(SubsidyID subsidy_id);
	 ...
	 * @return One of TownID/IndustryID.
	 */
	static int32_t GetDestinationIndex(SubsidyID subsidy_id);
};
